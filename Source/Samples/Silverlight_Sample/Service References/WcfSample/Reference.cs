...
// 
namespace Silverlight_Sample.WcfSample {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISampleWcfServiceChannel : Silverlight_Sample.WcfSample.ISampleWcfService, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SampleWcfServiceClient : System.ServiceModel.ClientBase<Silverlight_Sample.WcfSample.ISampleWcfService>, Silverlight_Sample.WcfSample.ISampleWcfService {
        ...
        System.IAsyncResult Silverlight_Sample.WcfSample.ISampleWcfService.BeginGetMessage(string key, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetMessage(key, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        string Silverlight_Sample.WcfSample.ISampleWcfService.EndGetMessage(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGetMessage(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((Silverlight_Sample.WcfSample.ISampleWcfService)(this)).BeginGetMessage(key, callback, asyncState);
        }
        
        private object[] OnEndGetMessage(System.IAsyncResult result) {
            string retVal = ((Silverlight_Sample.WcfSample.ISampleWcfService)(this)).EndGetMessage(result);
            return new object[] {
                    retVal};
        }
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult Silverlight_Sample.WcfSample.ISampleWcfService.BeginMakeError(System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginMakeError(callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        void Silverlight_Sample.WcfSample.ISampleWcfService.EndMakeError(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginMakeError(object[] inValues, System.AsyncCallback callback, object asyncState) {
            return ((Silverlight_Sample.WcfSample.ISampleWcfService)(this)).BeginMakeError(callback, asyncState);
        }
        
        private object[] OnEndMakeError(System.IAsyncResult result) {
            ((Silverlight_Sample.WcfSample.ISampleWcfService)(this)).EndMakeError(result);
            return null;
        }
        ...
        protected override Silverlight_Sample.WcfSample.ISampleWcfService CreateChannel() {
            return new SampleWcfServiceClientChannel(this);
        }
        
        private class SampleWcfServiceClientChannel : ChannelBase<Silverlight_Sample.WcfSample.ISampleWcfService>, Silverlight_Sample.WcfSample.ISampleWcfService {
            
            public SampleWcfServiceClientChannel(System.ServiceModel.ClientBase<Silverlight_Sample.WcfSample.ISampleWcfService> client) : 
                    base(client) {
            }
